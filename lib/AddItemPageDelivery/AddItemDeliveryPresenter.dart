...
class AddItemDeliverypresenter extends AddItemDeliveryContractor {
  GetTableListModelView getTableListModel;

  AddTablenoModelView addTablenoModelView;

  AddItemDeliveryModelView addItemPageModelView;
  ...
  AddItemDeliverypresenter(
    AddItemDeliveryModelView addItemPageView,
    AddmenuToCartModelview addMenuToCartModel,
    AddTablenoModelView addTablenoModelView,
    GetTableListModelView getTableListModel,
    ClearCartModelView clearCartModelView,
