...
//         createdAt: DateTime.parse(json["created_at"]),
//         updatedAt: DateTime.parse(json["updated_at"]),
//         list: List<ListElementss>.from(json["list"].map((x) => ListElementss.fromJson(x))),
...
//     factory ListElementss.fromJson(Map<String, dynamic> json) => ListElementss(
//         id: json["id"],
//         quantity: json["quantity"],
//         preparationTime: json["preparation_time"],
//         itemId: json["item_id"],
