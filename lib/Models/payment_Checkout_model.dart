...
//
//     final paymentCheckoutModel = paymentCheckoutModelFromJson(jsonString);

import 'dart:convert';

PaymentCheckoutModel paymentCheckoutModelFromJson(String str) => PaymentCheckoutModel.fromJson(json.decode(str));

String paymentCheckoutModelToJson(PaymentCheckoutModel data) => json.encode(data.toJson());
...
class PaymentCheckoutModel {
    ...
    factory PaymentCheckoutModel.fromJson(Map<String, dynamic> json) => PaymentCheckoutModel(
        status: json["status"],
