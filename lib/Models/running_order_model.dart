...
//
//     final runningOrderModel = runningOrderModelFromJson(jsonString);
...
class RunningOrderModel {
    ...
    factory RunningOrderModel.fromJson(Map<String, dynamic> json) => RunningOrderModel(
        status: json["status"],
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        takeAway:json["take_away"] != null ? DineIn.fromJson(json["take_away"]) :null,
    );
