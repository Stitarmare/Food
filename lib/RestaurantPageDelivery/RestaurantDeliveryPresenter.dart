...
class RestaurantDeliveryPresenter extends RestaurantDeliveryContractor {
  RestaurantDeliveryModelView restaurantView;
  RestaurantDeliveryPresenter(RestaurantDeliveryModelView restaurantModelView) {
  ...
  void getMenuList(int restId, BuildContext context,
      {String menu, int categoryId, int subCategoryId, int page}) {
    ApiBaseHelper()
