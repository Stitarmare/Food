...
class StatusTrackViewPresenter extends StatusTrackViewContractor {
  ...
  @override
  void getInvitedPeopleMember(int userId, int tableId, BuildContext context,
      {int orderId}) {
    ApiBaseHelper().post<InvitePeopleMember>(
        UrlConstant.getInvitedPeopleMember, context, body: {
      JSON_STR_ORDER_ID: orderId,
      ...
      switch (value.result) {
        case SuccessType.success:
          print(value.model);
          statusTrackModelView.getInvitedPeopleMemberSuccess(value.model.data);
          break;
        case SuccessType.failed:
