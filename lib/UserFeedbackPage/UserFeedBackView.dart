...
class UserFeedbackDialogView extends StatefulWidget {
  @override
  State createState() => new UserFeedbackDialogViewState();
}

class UserFeedbackDialogViewState extends State<UserFeedbackDialogView> {
  int _rating = 0;
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Image.asset("assets/FoodTrayIcon/plate.png",
                height: 150,
                width: 150,
                fit: BoxFit.fitWidth,
